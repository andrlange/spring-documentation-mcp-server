#!/bin/bash
# =============================================================================
# PostgreSQL Database Import Script (Linux/bash)
# =============================================================================
# Imports a spring_mcp database dump into a Docker container with pgvector
# Usage: ./import-linux.sh <input_file>
# =============================================================================
...
echo "╔════════════════════════════════════════════════════════════════════╗"
echo "║           PostgreSQL Database Import (Linux/bash)                  ║"
echo "╚════════════════════════════════════════════════════════════════════╝"
echo ""
...
if [[ -z "${INPUT_FILE}" ]]; then
    ...
    echo ""
    echo "Usage: ./import-linux.sh <backup_file.dump>"
    echo ""
    echo "Example:"
    echo "  ./import-linux.sh spring_mcp_backup_20250115_120000.dump"
    exit 1
fi
