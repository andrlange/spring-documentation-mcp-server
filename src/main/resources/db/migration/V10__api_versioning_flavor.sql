-- Spring MCP Server - API Versioning Flavor
-- Version: 1.3.3
-- Description: Add API Versioning with Spring Boot 4 flavor as default example
-- Date: 2025-12-04

-- Architecture Flavor: API Versioning with Spring Boot 4
...
(
    ...
    'API Versioning with Spring Boot 4',
    'ARCHITECTURE',
    'API Versioning Pattern',
    E'# API Versioning with Spring Boot 4 / Spring Framework 7
...
',
    'Comprehensive guide to Spring Framework 7''s first-class API versioning support including server configuration, client integration, deprecation handling, testing strategies, and troubleshooting common configuration errors like MissingApiVersionException',
    ARRAY['spring-boot-4', 'spring-framework-7', 'api-versioning', 'rest-api', 'backward-compatibility', 'api-evolution', 'troubleshooting'],
    '{"slugs": ["spring-boot-4", "spring-framework-7", "spring-webmvc"], "architectureType": "api-versioning", "springVersions": {"springBoot": "4.0+", "springFramework": "7.0+"}}',
    'system'
)
