---
unique-name: resilience
display-name: Core Resilience Features
category: ARCHITECTURE
pattern-name: Fault Tolerance
description: Built-in resilience features with @Retryable and @ConcurrencyLimit annotations for retry logic and concurrency control without external libraries
tags: resilience, retry, concurrency, fault-tolerance, backoff, spring-boot-4, 4.0
---
